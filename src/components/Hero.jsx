...
const Hero = () => {
    ...
    return (
        <section className={`relative min-h-[100svh] flex flex-col items-start justify-center overflow-hidden pt-20 sm:pt-24 md:pt-32 pb-8 sm:pb-10 transition-colors duration-1000 ${darkMode ? "bg-[#0a0a0a] text-white" : "bg-white text-black"}`}>
            ...
            <motion.div
                className="relative z-10 w-full max-w-6xl px-4 sm:px-6 md:px-8 lg:px-10 text-left flex flex-col justify-center"
    ...
    <motion.div
        ...
        className="mt-4 sm:mt-6 md:mt-8 lg:mt-10 ml-0 max-w-full sm:max-w-2xl md:max-w-3xl px-4 sm:px-0"
    >
                        
                            <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-black tracking-tight leading-[1.3] py-1 text-white">
