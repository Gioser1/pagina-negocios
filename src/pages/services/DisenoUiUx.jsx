                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center">
                    ...
                    >
                        ...
                        <motion.h1
                            ...
                            className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-white bg-[length:200%_auto] mb-6 tracking-tight leading-tight pb-2 md:pb-4"
