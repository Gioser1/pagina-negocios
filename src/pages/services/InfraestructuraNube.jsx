...
const services = [
    {
        ...
        benefits: [
            ...
            "Rediseño Cloud-Native",
            "Optimización de latencia",
            "Escalabilidad automática"
        ],
        stats: [
            { value: "99.9%", label: "disponibilidad" },
            { value: "-40%", label: "costos TCO" },
    ...
    },
    {
        ...
        benefits: [
            ...
            "Reportes de valor real"
        ],
        stats: [
            { value: "45%", label: "ahorro promedio" },
            { value: "100%", label: "visibilidad" },
            { value: "Zero", label: "desperdicio" }
        ],
    ...
    },
    {
        ...
        benefits: [
            ...
            "Prevención DLP avanzada",
            "SOC 24/7 con IA",
            "Cifrado AES-256"
        ],
        stats: [
            { value: "Zero", label: "brechas" },
    ...
    },
    {
        ...
        stats: [
            { value: "85%", label: "adopción cloud" },
            { value: "Zero", label: "mantenimiento" },
            { value: "Infinite", label: "burst" }
        ],
    ...
    },
    {
        ...
        benefits: [
            "VPC Peering & ExpressRoute",
            "Cloud Privada (Azure Stack)",
            "Storage Sincronizado",
            "Conectividad VPN Pro"
        ],
        stats: [
            { value: "Zero", label: "lock-in" },
            { value: "+50%", label: "flexibilidad" },
            ...
            >
                ...
                <section className="relative h-[750px] mx-8 md:mx-16 rounded-[5rem] overflow-hidden mb-40 border border-white/5 shadow-2xl">
                    <motion.div
                        ...
                        style={{
                            backgroundImage: "url('/imagenes/micrositios/Infraestructura-en-la-nube/cyber-security-concept-digital-art.jpg')",
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-12">
                        ...
                        <h1 className="text-7xl md:text-[10rem] font-black leading-[0.8] tracking-tighter mb-12 italic uppercase">
                            Infraestructura <br />
                            <GlitchText text="Cloud" className="text-sky-500 underline decoration-white/10 underline-offset-[25px]" />
                        </h1>
                ...
                <section className="max-w-7xl mx-auto px-12 mb-48">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-28 gap-12">
                        <div>
                            <span className="text-sky-500 font-black tracking-[0.7em] text-[11px] uppercase block mb-8 px-2">Expertise Cloud</span>
                        ...
                        <div className="relative z-10 grid lg:grid-cols-12 gap-24 items-center">
                            <div className="lg:col-span-7">
                                ...
                                <p className="text-2xl text-gray-500 mb-16 font-light italic leading-relaxed max-w-2xl opacity-90">
                                    La verdadera transformación no es digital, es <span className="text-sky-400 underline decoration-sky-500/30 underline-offset-8">estructural</span>. Diseñamos sistemas que se reparan solos y escalan antes que tú lo sepas.
                                </p>
                                <Link
                                ...
                                >
                                    Software Factory <span className="text-3xl transition-transform group-hover/link:translate-x-4">→</span>
                                </Link>
                            </div>
                ...
                <section className="relative py-60 px-12 text-center overflow-hidden">
                    ...
                    >
                        <h2 className="text-8xl md:text-[14rem] font-black leading-[0.75] tracking-tighter mb-20 italic uppercase">
                            Evolución <br /><span className="text-sky-600 drop-shadow-[0_0_80px_rgba(14,165,233,0.4)]">Garantizada.</span>
                        </h2>
