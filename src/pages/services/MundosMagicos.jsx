            ...
            <main className="min-h-screen bg-[#000000] text-white selection:bg-purple-500/30 overflow-x-hidden pt-28 pb-0 relative">
                ...
                <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 md:px-10 z-10 w-full overflow-hidden mb-20">
                    ...
                    >
                        ...
                        >
                          <button onClick={() => document.getElementById('servicios-inicio')?.scrollIntoView({ behavior: 'smooth' })} className="px-10 py-4 bg-purple-600 rounded-full font-black text-xs uppercase tracking-[0.2em] shadow-[0_0_40px_rgba(168,85,247,0.4)] hover:bg-purple-500 transition-all">
                            Conocer soluciones
                          </button>
                        </motion.div>
                        <MouseIndicator />
