...
const services = [
    {
        ...
        description: "Diseñamos y desarrollamos tokens y activos digitales que permiten representar valor, dentro de ecosistemas digitales seguros y transparentes.",
        icon: "⛓️",
        color: "#f97316",
        glowColor: "rgba(249,115,22,0.4)",
        benefits: ["Tokenización de activos reales y digitales", "Ecosistemas descentralizados seguros", "Smart contracts auditables", "Interoperabilidad entre redes blockchain"],
        stats: [{ value: "16T", label: "USD mercado 2030" }, { value: "30%", label: "menos intermediación" }, { value: "Web3", label: "nativo" }],
        image: "/imagenes/micrositios/domotica/beautiful-cryptocurrwncy-concept.jpg"
    },
    {
        title: "Creación de Tokens y Activos Digitales",
        description: "Digitalizamos activos para nuevas formas de inversión, propiedad y economía digital. Diseñamos y desarrollamos tokens y activos digitales basados en blockchain que permiten representar valor, propiedad o derechos dentro de ecosistemas digitales seguros y transparentes.",
        icon: "🪙",
        color: "#f59e0b",
        glowColor: "rgba(245,158,11,0.4)",
        benefits: ["Tokenización de activos físicos o digitales", "Transparencia en las transacciones", "Acceso a nuevos modelos de inversión", "Liquidez digital y mercados globales"],
        stats: [{ value: "16B", label: "USD para 2030" }, { value: "30%", label: "menos costos" }, { value: "100%", label: "trazable" }],
        image: "/imagenes/micrositios/domotica/2.png"
    },
    {
        title: "Trazabilidad Blockchain para Cadenas de Suministro",
        description: "Implementamos soluciones blockchain que permiten registrar, verificar y auditar cada movimiento de una cadena de suministro, garantizando transparencia, autenticidad y control de origen.",
        icon: "📦",
        color: "#10b981",
        glowColor: "rgba(16,185,129,0.4)",
        benefits: ["Registro inmutable de eventos", "Verificación de origen de productos", "Auditoría transparente de procesos", "Reducción de fraude y manipulación de datos"],
        stats: [{ value: "50%", label: "menos fraude" }, { value: "70%", label: "grandes empresas" }, { value: "30%", label: "eficiencia logística" }],
        image: "/imagenes/micrositios/domotica/3.png"
    },
    {
        title: "Integración Blockchain con IA, IoT y Ecosistemas Digitales",
        description: "Desarrollamos infraestructuras inteligentes que conectan datos, dispositivos y confianza digital con tecnologías BlockChain y emergentes como IA, IoT y plataformas digitales, permitiendo automatizar procesos, asegurar datos y crear ecosistemas descentralizados confiables.",
        icon: "🔗",
        color: "#6366f1",
        glowColor: "rgba(99,102,241,0.4)",
        benefits: ["Automatización mediante contratos inteligentes", "Integración segura de dispositivos IoT", "Validación confiable de datos generados por IA", "Ecosistemas digitales descentralizados"],
        stats: [{ value: "90%", label: "integridad datos" }, { value: "1.5B", label: "USD emergentes" }, { value: "24/7", label: "automatizado" }],
        image: "/imagenes/micrositios/domotica/4.png"
    },
    {
        title: "Transparencia, Trazabilidad y Confianza en Ecosistemas Digitales",
        description: "Implementamos infraestructuras blockchain que permiten registrar eventos, transacciones y procesos dentro de plataformas digitales con inmutabilidad, transparencia y verificabilidad pública o privada.",
        icon: "🔍",
        color: "#0ea5e9",
        glowColor: "rgba(14,165,233,0.4)",
        benefits: ["Registro inmutable de transacciones", "Auditoría transparente de procesos", "Reducción de intermediación", "Mayor confianza en ecosistemas digitales"],
        stats: [{ value: "50%", label: "menos fraude" }, { value: "1000+", label: "empresas globales" }, { value: "40%", label: "menos disputas" }],
        image: "/imagenes/micrositios/domotica/5.png"
    },
    {
        title: "Desarrollo de Módulos de Gestión Blockchain",
        description: "Diseñamos módulos de gestión basados en smart contracts que permiten automatizar procesos empresariales, financieros o legales dentro de plataformas digitales.",
        icon: "⚙️",
        color: "#8b5cf6",
        glowColor: "rgba(139,92,246,0.4)",
        benefits: ["Automatización sin intermediarios", "Ejecución automática de acuerdos", "Transparencia contractual", "Reducción de costos operativos"],
        stats: [{ value: "30%", label: "menos costos" }, { value: "80%", label: "más velocidad" }, { value: "35%", label: "crecimiento anual" }],
        image: "/imagenes/micrositios/domotica/6.png"
    },
    {
        title: "Identidad Digital (Layer 0)",
        description: "Desarrollamos sistemas de identidad digital descentralizada que permiten crear una huella criptográfica única para personas, empresas, dispositivos o activos digitales, operando sobre arquitecturas Layer 0 que funcionan como capa base de interoperabilidad entre múltiples redes BlockChain.",
        icon: "🪪",
        color: "#ec4899",
        glowColor: "rgba(236,72,153,0.4)",
        benefits: ["Identidad digital verificable", "Interoperabilidad entre redes blockchain", "Seguridad criptográfica avanzada", "Control de datos por el usuario"],
        stats: [{ value: "60%", label: "menos fraude" }, { value: "5T", label: "USD identidad" }, { value: "L0", label: "multi-chain" }],
        image: "/imagenes/micrositios/domotica/7.png"
    }
];

const METRICS = [
    { val: "16",   suf: "T",  lab: "USD MERCADO 2030" },
    { val: "50",   suf: "%",  lab: "MENOS FRAUDE" },
    { val: "90",   suf: "%",  lab: "INTEGRIDAD DATOS" },
    { val: "Zero", suf: "",   lab: "INTERMEDIARIOS" }
];
                ...
                <div className="p-6 sm:p-8 md:p-10 flex flex-col flex-1">
                    ...
                    <footer className="mt-auto flex items-center gap-4">
                        ...
                        <span className="text-[9px] sm:text-[10px] uppercase font-black tracking-[0.3em] sm:tracking-[0.4em] text-sky-400 opacity-60">
                            {open ? "Cerrar Detalle" : "Ver Solución"}
                        </span>
                    </footer>
                </div>
            ...
            >
                ...
                <section className="relative mx-4 sm:mx-8 md:mx-16 rounded-[2.5rem] sm:rounded-[4rem] md:rounded-[5rem] overflow-hidden mb-20 sm:mb-32 md:mb-40 border border-white/5 shadow-2xl min-h-[600px] sm:min-h-[680px] md:min-h-[750px] flex items-center">
                    ...
                    >
                        ...
                        >
                            Confianza digital. Valor descentralizado.
                        </motion.span>
                        ...
                        >
                            <TypingText
                                texts={[
                                    "Tokens, contratos inteligentes y ecosistemas seguros.",
                                    "Transparencia total en cada transacción.",
                                    "Activos digitales que trabajan por ti.",
                                    "Decisiones respaldadas por la inmutabilidad blockchain."
                                ]}
                        ...
                        >
                            Diseñamos e implementamos infraestructuras blockchain que tokenizan activos, automatizan
                            procesos mediante smart contracts y construyen ecosistemas digitales seguros,
                            transparentes e interoperables.
                        </motion.p>
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 sm:mb-24 md:mb-28 gap-8 sm:gap-12">
                        <div>
                            ...
                            <h2 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-none italic uppercase">
                                Nuestras <br /><span className="text-sky-900/50 underline decoration-sky-500/10">Soluciones</span>
                            </h2>
                        </div>
                        <p className="text-gray-400 max-w-sm text-left md:text-right italic text-base sm:text-xl leading-relaxed md:border-r-4 border-sky-600 md:pr-10 opacity-80">
                            Blockchain de precisión para activos y procesos que no pueden fallar.
                        </p>
                    </div>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-8 md:px-12 mb-24 sm:mb-36 md:mb-48">
                    <div className="relative rounded-[2.5rem] sm:rounded-[4rem] md:rounded-[6rem] overflow-hidden border border-white/5 bg-gradient-to-br from-[#020202] to-[#080808] p-8 sm:p-16 md:p-24 lg:p-36 group shadow-2xl">
                        <div
                            ...
                            style={{ backgroundImage: "url('/imagenes/micrositios/domotica/banner.jpg')" }}
                        />
                        <div className="relative z-10 grid lg:grid-cols-12 gap-12 sm:gap-16 md:gap-24 items-center">
                            <div className="lg:col-span-7">
                                ...
                                <p className="text-base sm:text-xl md:text-2xl text-gray-500 mb-8 sm:mb-12 md:mb-16 font-light italic leading-relaxed max-w-2xl opacity-90">
                                    La verdadera revolución no es tecnológica, es de{" "}
                                    <span className="text-sky-400 underline decoration-sky-500/30 underline-offset-8">confianza</span>.
                                    Diseñamos infraestructuras blockchain que operan solas y escalan con tu ecosistema digital.
                                </p>
                                <Link
                            ...
                            <div className="lg:col-span-5 grid grid-cols-1 gap-4 sm:gap-6 md:gap-8">
                                {[
                                    { t: "Blockchain Nativo",   d: "Ethereum · Polkadot · Solana · Layer 0" },
                                    { t: "Smart Contracts",     d: "Auditoría · Despliegue · Sin Intermediarios" },
                                    { t: "Datos Inmutables",    d: "Trazabilidad · Transparencia · Tiempo Real" }
                                ].map((box, i) => (
                                    <motion.div
                                        key={i}
                                        whileHover={{ x: 16 }}
                ...
                <section className="relative py-32 sm:py-48 md:py-60 px-4 sm:px-8 md:px-12 text-center overflow-hidden">
                    ...
                    >
                        ...
                        <p className="text-lg sm:text-2xl md:text-3xl text-gray-500 mb-14 sm:mb-20 md:mb-24 italic font-light max-w-4xl mx-auto leading-relaxed px-4">
                            Analizamos tus activos y procesos actuales y diseñamos el mapa hacia la descentralización
                ...
                <footer className="py-20 sm:py-28 md:py-40 px-8 md:px-12 border-t border-white/5 text-center bg-black">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-gray-600 text-[10px] sm:text-[11px] font-black tracking-[0.5em] sm:tracking-[0.8em] uppercase leading-relaxed">
                            © {new Date().getFullYear()} Olimpo Innova • Blockchain & Web3 Architects
                        </p>
                    </div>
                </footer>
