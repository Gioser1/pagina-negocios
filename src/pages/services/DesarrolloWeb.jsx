...
const DesarrolloWeb = () => {
    ...
    return (
        <main className="min-h-screen pt-28 md:pt-32 pb-20 md:pb-24">
            {/* Hero del Servicio */}
            <section className="relative py-16 md:py-24 mb-12 md:mb-16 overflow-hidden rounded-3xl mx-4 sm:mx-6 lg:mx-8 bg-gradient-to-br from-emerald-500 to-teal-700">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center">
                    ...
                    >
                        ...
                        <motion.h1
                            ...
                            className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-teal-200 to-white bg-[length:200%_auto] mb-6 tracking-tight leading-tight pb-2 md:pb-4"
                        ...
                        >
                            Arquitecturas escalables para negocios que no se conforman.
                        </motion.p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-dark-100/40 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 md:p-12 shadow-sm border border-white/5 mb-8">
                            ...
                            >
                                ...
                                >
                                    Construimos aplicaciones web de alto rendimiento usando las últimas tecnologías (React, Node, Next.js). Nuestro enfoque no está en hacer "solo una página", sino en desarrollar herramientas digitales que aceleren el crecimiento de tu empresa.
                                </motion.p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                                    {["Aplicaciones Single-Page (SPA)", "Optimizado para altas cargas de tráfico", "Integraciones de API complejas", "Arquitectura escalable AWS/Vercel"].map((feature, idx) => (
